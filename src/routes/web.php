...
Route::group(['prefix' => Config::get('location.routes.prefix'), 'namespace' => 'Bdhabib\Location\Http\Controllers', 'middleware' => [Config::get('location.routes.middleware')]], function () {
    # Get all Countries
